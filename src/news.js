...
class News extends Component{
    ...
    componentDidMount(){
        ...
        document.getElementById("headline2").addEventListener("click", function(){
            document.getElementById('article1').className='article'
            document.getElementById('standfirst1').className='urlLink'
            })

        document.getElementById("headline3").addEventListener("click", function(){
            document.getElementById('article2').className='article'
            document.getElementById('standfirst2').className='urlLink'
            })

        document.getElementById("headline4").addEventListener("click", function(){
            document.getElementById('article3').className='article'
            document.getElementById('standfirst3').className='urlLink'
            })            
    }
    ...
    render(){
        return(
            <div>
                ...
                <p>Click Headline to find out more</p>
                <img src={this.state.api1.response.content.fields.thumbnail} id='img1' alt='image1'></img><br></br><br></br>
                <p className='hidden' id='standfirst1'><a href="https://www.theguardian.com/world/2021/mar/22/link-between-diabetes-and-coronavirus-infections" target="_blank">{this.state.api1.response.content.fields.standfirst}</a></p>
                ...
                <p className='hidden' id='standfirst2'><a href="https://www.theguardian.com/football/2021/jun/05/aston-villa-agree-30m-deal-for-norwich-midfielder-emiliano-buendia" target="_blank">{this.state.api2.response.content.fields.standfirst}</a></p>               
                ...
                <p className='hidden' id='standfirst3'><a href="https://www.theguardian.com/tv-and-radio/2021/jul/22/clarksons-farm-best-thing-jeremy-clarkson-has-done-amazon" target="_blank" >{this.state.api3.response.content.fields.standfirst}</a></p>
